...
public class Environment {
    ...
    public static final String url = "-feature.test.blacklake.tech";
    ...
    public static final int storageId = 1319; //可以存放所有状态
    public static final int inStorageId = 1321;//可以存放所有状态
